...
public class QuizGame {
    ...
    public void iniciar() {
        ...
        for(int i = 0; i < perguntas.length; i++){
            ...
            if(resposta.equals("a")||resposta.equals("b")||resposta.equals("c")||resposta.equals("d")){ //Verifica se a resposta é válida
                ...
                cont++;
                    ...
                    System.out.println("A resposta correta é: " + perguntas[i].resposta);
                    System.out.println("================================================================================================\n");
                }
            }else{
